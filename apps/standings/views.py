...
from .calculator import (
    bp_team_standings, bp_speaker_standings,
...
def team_tab(request, slug):
    ...
    if t.is_bp:
        ...
        standings = []
    return render(request, "standings/team_tab.html", {"tournament": t, "standings": standings})
...
def speaker_tab(request, slug):
    ...
    if t.is_bp:
        ...
        standings = []
    return render(request, "standings/speaker_tab.html", {"tournament": t, "standings": standings})
...
def public_team_tab(request, slug):
    ...
    if t.is_bp:
        ...
        standings = []
    return render(request, "public/team_tab.html", {"tournament": t, "standings": standings})
...
def public_speaker_tab(request, slug):
    ...
    if t.is_bp:
        ...
        standings = []
    return render(request, "public/speaker_tab.html", {"tournament": t, "standings": standings})
